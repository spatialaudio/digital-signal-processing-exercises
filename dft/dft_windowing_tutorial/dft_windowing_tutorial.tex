...
\begin{figure}[t]
		\centering
		\includegraphics[width=6in, height=4in]{graphics/dft_eigensignals_columns.pdf}
...
\begin{figure}[b!]
		\centering
		\includegraphics[width=6in, height=4in]{graphics/TwiddleFactorMatrix_N8.pdf}
...
\begin{figure}[t]
		\centering
		\includegraphics[width=6in, height=4in]{graphics/TwiddleFactorMatrix_N9.pdf}
		\caption{$\text{arg}(W_N^{\mu k})$ (left) and $|\text{arg}(W_N^{\mu k}|$
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=4in]{graphics/TwiddleFactorMatrix_N48.pdf}
		\caption{$\text{arg}(W_N^{\mu k})$ (left) and $|\text{arg}(W_N^{\mu k})|$
...
\begin{figure}[b!]
		\centering
		\includegraphics[width=6in, height=4in]{graphics/Periodicity_DFT.pdf}
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=4in]{graphics/Symmetry_DFT_N8.pdf}
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=4in]{graphics/Symmetry_DFT_N9.pdf}
...
\begin{figure}
		\centering
		\includegraphics[width=7in, height=4in]{graphics/DFT_Eigenfrequencies_N4_N5.pdf}
...
\begin{figure}
		\centering
		\includegraphics[width=7in, height=4in]{graphics/DFT_Eigenfrequencies_N8_N9.pdf}
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=6in]{graphics/DTFT_Interpolation.pdf}
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=2.5in]{graphics/RectWindow_DTFT_DFT_lin_asym.pdf}
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=2.5in]{graphics/RectWindow_DTFT_DFT_lin_sym.pdf}
		\caption{Magnitude of DTFT \& DFT spectra for rectangular windows of length
		$N$, $-\pi\leq\Omega<\pi$.}
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=2.5in]{graphics/RectWindow_DTFT_DFT_log_asym.pdf}
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=2.5in]{graphics/RectWindow_DTFT_DFT_log_sym.pdf}
		\caption{Level of DTFT spectra for rectangular windows of length $N$,
		$-\pi\leq\Omega<\pi$.}
...
\begin{figure}
		\centering
		\includegraphics[width=6in, height=3.5in]{graphics/HannDefinitionen.pdf}
...
\begin{enumerate}[label=\alph*)]
 ...
 With Euler's identity
	...
	\item \text{}
	\begin{center}%
		\includegraphics[width=6in, height=3.5in]{graphics/UE1_Exercise2_IDFT.pdf}%
...
\begin{enumerate}[label=\alph*)]
  ...
  \end{align}
	...
	\item \text{}
	\begin{center}%
		\includegraphics[width=6in, height=3.5in]{graphics/UE1_Exercise4_Spectrum.pdf}%
